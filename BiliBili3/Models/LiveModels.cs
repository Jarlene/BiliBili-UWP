...
namespace BiliBili3.Models
{
    ...
    public class FeedModel
    {
        ...
        public string FansNum
        {
            get
            {
                if (fansNum > 10000)
                {
                    return ((double)fansNum / 10000).ToString("0.0" + "万");
                }
                else
                {
                    return fansNum.ToString();
                }
            }
        }
        ...
        public Visibility liveing
        {
            get
            {
                if (live_status == 1 && round_status == 0)
                {
        ...
        public Visibility rounding
        {
            get
            {
                if (live_status == 0 && round_status == 1)
                {
                    return Visibility.Visible;
                }
                else
        ...
        public Visibility stop
        {
            get
            {
                if (live_status == 0 && round_status == 0)
                {
                    return Visibility.Visible;
                }
                else
    ...
    public class LiveSearchModel
    {
        public int code { get; set; }
        public string message { get; set; }
        public LiveSearchModel data { get; set; }

        public LiveSearchModel room { get; set; }
        public LiveSearchModel user { get; set; }
        public List<LiveSearchModel> list { get; set; }
    ...
    public class LiveMyGiftsModel
    {
        public int code { get; set; }
        public string message { get; set; }
        public List<LiveMyGiftsModel> data { get; set; }
        public string id { get; set; }
        public string uid { get; set; }
