    ...
    public sealed partial class MyCollectPage : Page
    {
        ...
        public async Task<List<GetFavouriteBoxsVideoModel>> GetFavouriteBoxVideo(string fid, int PageNum)
        {
            //啊啊啊啊，没心情啊，下面代码都是乱写的，啊啊啊啊啊 啊啊啊啊啊啊
                ...
                try
                {
                    ...
                    string results = await WebClientClass.GetResults(new Uri("http://space.bilibili.com/ajax/fav/getList?mid=" + ApiHelper.GetUserId() + "&pagesize=20&fid=" + fid + "&pid=" + PageNum));
                    //一层
        ...
        private async void GetFavouriteBoxVideo()
        {
            ...
            try
            {
                ...
                {
                    messShow.Show("信息获取失败",3000);

                }
            }
            catch (Exception)
            {
                messShow.Show("读取收藏夹信息失败", 3000);
            }
            finally
            {
