    ...
    public sealed partial class FindPage : Page
    {
        ...
        public async void GetHotKeyword()
        {
            try
            {
                ...
                string results = await WebClientClass.GetResults(new Uri("http://www.bilibili.com/search?action=hotword&main_ver=v1"));
        ...
        {
            MessageCenter.SendNavigateTo(NavigateMode.Info, typeof(PartPage));
        }
        ...
        {
            MessageCenter.SendNavigateTo(NavigateMode.Info, typeof(WebPage), "http://bmall.bilibili.com/#!/");
        }
