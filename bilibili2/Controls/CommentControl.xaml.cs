...
namespace bilibili2.Controls
{
    public sealed partial class CommentControl : UserControl
    {
        ...
        private void Grid_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            rpid = ((sender as Grid).DataContext as NewCommentModel).rpid;
        ...
        private async void btn_Send_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (getUser.IsLogin())
            {
                try
                {
                    string uri = string.Format("http://api.bilibili.com/x/reply/add?_device=wp&build=427000&platform=wp&appkey={0}&access_key={1}", ApiHelper._appKey, ApiHelper.access_key);
                    ...
                    {
                        messShow.Show(json["message"].ToString(), 3000);
                    }
